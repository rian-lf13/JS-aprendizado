...
console.log('Meu nome é "Rian"');
console.log(`Tenho 23 anos!`);
// String= Textos
console.log(24+5);
console.log(12.50);
console.log(1234567);
...
console.log('Exercício de fixação(refazendo):')

// Exercicio de fixação
console.log(`Meu nome é "Rian", sou estudante de ADS do primeiro semestre, faz 1 ano que estou flertando com programação e estou entusiasmado com meus últimos meses. Codei com mais frequência e estou revisando tudo que já aprendi para que possa seguir com o curso e me especializar em JS.`)
